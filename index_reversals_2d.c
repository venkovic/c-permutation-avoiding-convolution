...
int* precompute_index_reversal_permutation_r2_2d(int n1, int n2) {
  ...
  for (int i1 = 0; i1 < n1; ++i1) {
    for (int i2 = 0; i2 < n2; ++i2) {
      ...
      // Apply bit-reversal to row and column indices independently
      int rev_i1 = reverse_index_r2(i1, t1);
      int rev_i2 = reverse_index_r2(i2, t2);
      int rev_idx = rev_i1 * n2 + rev_i2;
...
int* precompute_index_reversal_permutation_r4_2d(int n1, int n2) {
  ...
  // Calculate log4 for both dimensions
  int t1 = 0, temp1 = n1;
  ...
  for (int i1 = 0; i1 < n1; ++i1) {
    for (int i2 = 0; i2 < n2; ++i2) {
      ...
      // Apply radix-4 bit-reversal to row and column indices independently
