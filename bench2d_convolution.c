...
int main(int argc, char** argv) {
  ...
  fftw_plan p_forward = fftw_plan_dft_2d(n1, n2, fftw_in, fftw_out, FFTW_FORWARD, FFTW_ESTIMATE | FFTW_NO_SIMD);
  fftw_plan p_backward = fftw_plan_dft_2d(n1, n2, fftw_out, fftw_in, FFTW_BACKWARD, FFTW_ESTIMATE | FFTW_NO_SIMD);
