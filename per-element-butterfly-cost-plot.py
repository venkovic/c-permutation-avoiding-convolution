...
dt_r2_1D = np.array([.0155, .0865,  .3805, 1.6935,   7.343])
n_r2_1D  = np.array([2**20, 2**22,  2**24,  2**26,   2**28])
dt_r4_1D = np.array([ .011, .0535,   .237,  1.033,  4.5545])
n_r4_1D  = np.array([2**20, 2**22,  2**24,  2**26,   2**28])
dt_r2_2D = np.array([ .024, .1865,  1.011,  4.530,  20.967])
n_r2_2D  = np.array([2**20, 2**22,  2**24,  2**26,   2**28])
dt_r4_2D = np.array([.0255,         1.030,         19.9895])
n_r4_2D  = np.array([2**20,         2**24,           2**28])
dt_r2_3D = np.array([.0840,        1.1465,          9.0095])
n_r2_3D  = np.array([2**21,         2**24,           2**27])
dt_r4_3D = np.array([              1.1705                 ])
...
ax[0].set_ylabel("Per-element butterfly cost, "  + r'$s$', fontsize=fontsize)
