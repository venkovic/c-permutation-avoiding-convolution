...
int main(int argc, char** argv) {
  ...
  if (do_verify) {
    ...
    // Radix-2
    fft_based_convolution_3d(re, im, n1, n2, n3, 2, twiddle_re1, twiddle_im1, twiddle_re2, twiddle_im2, twiddle_re3, twiddle_im3, rho, g_re, g_im);
    ...
    permutation_avoiding_convolution_3d(re, im, n1, n2, n3, 2, twiddle_re1, twiddle_im1, twiddle_re2, twiddle_im2, twiddle_re3, twiddle_im3, Pg_re, Pg_im);
    ...
    if (supports_radix_4(t2_1) && supports_radix_4(t2_2) && supports_radix_4(t2_3)) {
      ...
      // FFT-based Radix-4
      fft_based_convolution_3d(re, im, n1, n2, n3, 4, twiddle_re1, twiddle_im1, twiddle_re2, twiddle_im2, twiddle_re3, twiddle_im3, rho, g_re, g_im);
      ...
      permutation_avoiding_convolution_3d(re, im, n1, n2, n3, 4, twiddle_re1, twiddle_im1, twiddle_re2, twiddle_im2, twiddle_re3, twiddle_im3, Pg_re, Pg_im);
